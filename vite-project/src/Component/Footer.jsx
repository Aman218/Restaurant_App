        ...
        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
          <form class="w-full">
            ...
            >
              ...
              <button
                class="mt-1 w-full bg-[#FF5200] px-6 py-3 text-sm font-bold uppercase tracking-wide text-white transition-none hover:bg-[#FF4020] sm:mt-0 sm:w-auto sm:shrink-0"
              >
                Sign Up
              </button>
            </div>
